...
class OnNotificationArmStateTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationArmStateTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationArmStateTopicRequest
    let len;
    let data = new OnNotificationArmStateTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationArmStateTopicRequest(null);
...
class OnNotificationArmStateTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationArmStateTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationArmStateTopicResponse
    let len;
    let data = new OnNotificationArmStateTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationArmStateTopicResponse(null);
...
module.exports = {
  Request: OnNotificationArmStateTopicRequest,
  Response: OnNotificationArmStateTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationArmStateTopic'; }
};
