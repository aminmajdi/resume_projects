...
class OnNotificationFactoryTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationFactoryTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationFactoryTopicRequest
    let len;
    let data = new OnNotificationFactoryTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationFactoryTopicRequest(null);
...
class OnNotificationFactoryTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationFactoryTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationFactoryTopicResponse
    let len;
    let data = new OnNotificationFactoryTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationFactoryTopicResponse(null);
...
module.exports = {
  Request: OnNotificationFactoryTopicRequest,
  Response: OnNotificationFactoryTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationFactoryTopic'; }
};
