...
(cl:defclass <MapGroupHandle> (roslisp-msg-protocol:ros-message)
  ((identifier
    :reader identifier
    :initarg :identifier
    :type cl:integer
...
(cl:defclass MapGroupHandle (<MapGroupHandle>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MapGroupHandle>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MapGroupHandle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<MapGroupHandle> is deprecated: use kortex_driver-msg:MapGroupHandle instead.")))

(cl:ensure-generic-function 'identifier-val :lambda-list '(m))
(cl:defmethod identifier-val ((m <MapGroupHandle>))
...
(cl:defmethod permission-val ((m <MapGroupHandle>))
  ...
  (permission m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MapGroupHandle>) ostream)
  "Serializes a message object of type '<MapGroupHandle>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapGroupHandle>) istream)
  "Deserializes a message object of type '<MapGroupHandle>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MapGroupHandle>)))
  "Returns string type for a message object of type '<MapGroupHandle>"
  "kortex_driver/MapGroupHandle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MapGroupHandle)))
  "Returns string type for a message object of type 'MapGroupHandle"
  "kortex_driver/MapGroupHandle")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MapGroupHandle>)))
  "Returns md5sum for a message object of type '<MapGroupHandle>"
  "10d841c6abc3fd3596d9b10510d50074")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MapGroupHandle)))
  "Returns md5sum for a message object of type 'MapGroupHandle"
  "10d841c6abc3fd3596d9b10510d50074")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MapGroupHandle>)))
  "Returns full string definition for message of type '<MapGroupHandle>"
  (cl:format cl:nil "~%uint32 identifier~%uint32 permission~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MapGroupHandle)))
  "Returns full string definition for message of type 'MapGroupHandle"
  (cl:format cl:nil "~%uint32 identifier~%uint32 permission~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MapGroupHandle>))
  (cl:+ 0
     4
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MapGroupHandle>))
  "Converts a ROS message object to a list"
  (cl:list 'MapGroupHandle
