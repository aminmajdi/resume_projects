...
"""autogenerated by genpy from kortex_driver/SafetyNotificationList.msg. Do not edit."""
import codecs
import sys
...
class SafetyNotificationList(genpy.Message):
  _md5sum = "c064ceaeac74b1cd3d7784c6defce6b7"
  _type = "kortex_driver/SafetyNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/SafetyNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SafetyNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.SafetyNotification()
        _v6 = val1.safety_handle
        start = end
        end += 4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.SafetyNotification()
        _v16 = val1.safety_handle
        start = end
        end += 4
        (_v16.identifier,) = _get_struct_I().unpack(str[start:end])
        start = end
        end += 4
        (val1.value,) = _get_struct_I().unpack(str[start:end])
        _v17 = val1.timestamp
