...
class Base_CapSenseMode {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Base_CapSenseMode(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Base_CapSenseMode(null);
    return resolved;
    }
};

// Constants for message
Base_CapSenseMode.Constants = {
  RESERVED: 0,
  INACTIVE: 1,
...
module.exports = Base_CapSenseMode;
