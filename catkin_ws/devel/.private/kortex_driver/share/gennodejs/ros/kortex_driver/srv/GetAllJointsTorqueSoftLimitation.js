...
class GetAllJointsTorqueSoftLimitationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAllJointsTorqueSoftLimitationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAllJointsTorqueSoftLimitationRequest
    let len;
    let data = new GetAllJointsTorqueSoftLimitationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAllJointsTorqueSoftLimitationRequest(null);
...
class GetAllJointsTorqueSoftLimitationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAllJointsTorqueSoftLimitationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAllJointsTorqueSoftLimitationResponse
    let len;
    let data = new GetAllJointsTorqueSoftLimitationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAllJointsTorqueSoftLimitationResponse(null);
...
module.exports = {
  Request: GetAllJointsTorqueSoftLimitationRequest,
  Response: GetAllJointsTorqueSoftLimitationResponse,
  md5sum() { return '80ab5247f79a646a096a6bb5bc451a7d'; },
  datatype() { return 'kortex_driver/GetAllJointsTorqueSoftLimitation'; }
};
