...
class InterconnectCyclic_ServiceVersion {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new InterconnectCyclic_ServiceVersion(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InterconnectCyclic_ServiceVersion(null);
    return resolved;
    }
};

// Constants for message
InterconnectCyclic_ServiceVersion.Constants = {
  RESERVED_0: 0,
  CURRENT_VERSION: 1,
}

module.exports = InterconnectCyclic_ServiceVersion;
