...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<Pose> is deprecated: use kortex_driver-msg:Pose instead.")))
...
(cl:defmethod theta_x-val ((m <Pose>))
...
(cl:defmethod theta_y-val ((m <Pose>))
...
(cl:defmethod theta_z-val ((m <Pose>))
