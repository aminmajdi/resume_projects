...
class GetAllJointsTorqueHardLimitationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAllJointsTorqueHardLimitationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAllJointsTorqueHardLimitationRequest
    let len;
    let data = new GetAllJointsTorqueHardLimitationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAllJointsTorqueHardLimitationRequest(null);
...
class GetAllJointsTorqueHardLimitationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAllJointsTorqueHardLimitationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAllJointsTorqueHardLimitationResponse
    let len;
    let data = new GetAllJointsTorqueHardLimitationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAllJointsTorqueHardLimitationResponse(null);
...
module.exports = {
  Request: GetAllJointsTorqueHardLimitationRequest,
  Response: GetAllJointsTorqueHardLimitationResponse,
  md5sum() { return '80ab5247f79a646a096a6bb5bc451a7d'; },
  datatype() { return 'kortex_driver/GetAllJointsTorqueHardLimitation'; }
};
