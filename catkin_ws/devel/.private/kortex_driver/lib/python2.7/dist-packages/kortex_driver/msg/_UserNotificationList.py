...
"""autogenerated by genpy from kortex_driver/UserNotificationList.msg. Do not edit."""
import codecs
import sys
...
class UserNotificationList(genpy.Message):
  _md5sum = "758e6f505a108790f7c5f9f46bc75ba3"
  _type = "kortex_driver/UserNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/UserNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UserNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.UserNotification()
        start = end
        end += 4
        (val1.user_event,) = _get_struct_I().unpack(str[start:end])
        _v6 = val1.modified_user
        _x = _v6
        start = end
        end += 8
