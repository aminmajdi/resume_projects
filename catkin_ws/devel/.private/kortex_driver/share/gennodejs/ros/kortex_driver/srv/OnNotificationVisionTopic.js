...
class OnNotificationVisionTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationVisionTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationVisionTopicRequest
    let len;
    let data = new OnNotificationVisionTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationVisionTopicRequest(null);
...
class OnNotificationVisionTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationVisionTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationVisionTopicResponse
    let len;
    let data = new OnNotificationVisionTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationVisionTopicResponse(null);
...
module.exports = {
  Request: OnNotificationVisionTopicRequest,
  Response: OnNotificationVisionTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationVisionTopic'; }
};
