...
class OnNotificationControlModeTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationControlModeTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationControlModeTopicRequest
    let len;
    let data = new OnNotificationControlModeTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationControlModeTopicRequest(null);
...
class OnNotificationControlModeTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationControlModeTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationControlModeTopicResponse
    let len;
    let data = new OnNotificationControlModeTopicResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'kortex_driver/OnNotificationControlModeTopicResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationControlModeTopicResponse(null);
...
module.exports = {
  Request: OnNotificationControlModeTopicRequest,
  Response: OnNotificationControlModeTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationControlModeTopic'; }
};
