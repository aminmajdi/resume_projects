...
class OnNotificationSafetyTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationSafetyTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationSafetyTopicRequest
    let len;
    let data = new OnNotificationSafetyTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationSafetyTopicRequest(null);
...
class OnNotificationSafetyTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationSafetyTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationSafetyTopicResponse
    let len;
    let data = new OnNotificationSafetyTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationSafetyTopicResponse(null);
...
module.exports = {
  Request: OnNotificationSafetyTopicRequest,
  Response: OnNotificationSafetyTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationSafetyTopic'; }
};
