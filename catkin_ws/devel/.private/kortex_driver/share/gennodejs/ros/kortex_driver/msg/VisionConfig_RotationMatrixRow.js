...
class VisionConfig_RotationMatrixRow {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VisionConfig_RotationMatrixRow(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisionConfig_RotationMatrixRow(null);
...
module.exports = VisionConfig_RotationMatrixRow;
