...
class ControlConfig_ControlModeInformation {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ControlConfig_ControlModeInformation(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControlConfig_ControlModeInformation(null);
...
module.exports = ControlConfig_ControlModeInformation;
