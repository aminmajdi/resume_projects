...
class OnNotificationMappingInfoTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationMappingInfoTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationMappingInfoTopicRequest
    let len;
    let data = new OnNotificationMappingInfoTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationMappingInfoTopicRequest(null);
...
class OnNotificationMappingInfoTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationMappingInfoTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationMappingInfoTopicResponse
    let len;
    let data = new OnNotificationMappingInfoTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationMappingInfoTopicResponse(null);
...
module.exports = {
  Request: OnNotificationMappingInfoTopicRequest,
  Response: OnNotificationMappingInfoTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationMappingInfoTopic'; }
};
