...
"""autogenerated by genpy from kortex_driver/RobotEventNotificationList.msg. Do not edit."""
import codecs
import sys
...
class RobotEventNotificationList(genpy.Message):
  _md5sum = "31f7be45a79909d8e884dbb37990a7f2"
  _type = "kortex_driver/RobotEventNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/RobotEventNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotEventNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.RobotEventNotification()
        start = end
        end += 4
