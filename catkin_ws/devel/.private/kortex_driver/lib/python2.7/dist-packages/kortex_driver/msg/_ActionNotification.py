...
class ActionNotification(genpy.Message):
  _md5sum = "0b783b1807e59b154e3f4695d4fecd26"
...
uint32 connection_identifier"""
  __slots__ = ['action_event','handle','timestamp','user_handle','abort_details','connection']
  _slot_types = ['uint32','kortex_driver/ActionHandle','kortex_driver/Timestamp','kortex_driver/UserProfileHandle','uint32','kortex_driver/Connection']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       action_event,handle,timestamp,user_handle,abort_details,connection
