...
class OnNotificationSequenceInfoTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationSequenceInfoTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationSequenceInfoTopicRequest
    let len;
    let data = new OnNotificationSequenceInfoTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationSequenceInfoTopicRequest(null);
...
class OnNotificationSequenceInfoTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationSequenceInfoTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationSequenceInfoTopicResponse
    let len;
    let data = new OnNotificationSequenceInfoTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationSequenceInfoTopicResponse(null);
...
module.exports = {
  Request: OnNotificationSequenceInfoTopicRequest,
  Response: OnNotificationSequenceInfoTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationSequenceInfoTopic'; }
};
