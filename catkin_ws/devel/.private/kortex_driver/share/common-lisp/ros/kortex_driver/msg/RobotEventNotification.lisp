...
(cl:defclass <RobotEventNotification> (roslisp-msg-protocol:ros-message)
  ((event
    :reader event
    :initarg :event
    :type cl:integer
...
(cl:defclass RobotEventNotification (<RobotEventNotification>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RobotEventNotification>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RobotEventNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<RobotEventNotification> is deprecated: use kortex_driver-msg:RobotEventNotification instead.")))

(cl:ensure-generic-function 'event-val :lambda-list '(m))
(cl:defmethod event-val ((m <RobotEventNotification>))
...
(cl:defmethod handle-val ((m <RobotEventNotification>))
...
(cl:defmethod timestamp-val ((m <RobotEventNotification>))
...
(cl:defmethod user_handle-val ((m <RobotEventNotification>))
...
(cl:defmethod connection-val ((m <RobotEventNotification>))
  ...
  (connection m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotEventNotification>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotEventNotification>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotEventNotification>)))
  "Returns string type for a message object of type '<RobotEventNotification>"
  "kortex_driver/RobotEventNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotEventNotification)))
  "Returns string type for a message object of type 'RobotEventNotification"
  "kortex_driver/RobotEventNotification")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotEventNotification>)))
  "Returns md5sum for a message object of type '<RobotEventNotification>"
  "b007c688b887811439b885aca5e71931")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotEventNotification)))
  "Returns md5sum for a message object of type 'RobotEventNotification"
  "b007c688b887811439b885aca5e71931")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotEventNotification>)))
  "Returns full string definition for message of type '<RobotEventNotification>"
  (cl:format cl:nil "~%uint32 event~%DeviceHandle handle~%Timestamp timestamp~%UserProfileHandle user_handle~%Connection connection~%================================================================================~%MSG: kortex_driver/DeviceHandle~%~%uint32 device_type~%uint32 device_identifier~%uint32 order~%================================================================================~%MSG: kortex_driver/Timestamp~%~%uint32 sec~%uint32 usec~%================================================================================~%MSG: kortex_driver/UserProfileHandle~%~%uint32 identifier~%uint32 permission~%================================================================================~%MSG: kortex_driver/Connection~%~%UserProfileHandle user_handle~%string connection_information~%uint32 connection_identifier~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotEventNotification)))
  "Returns full string definition for message of type 'RobotEventNotification"
  (cl:format cl:nil "~%uint32 event~%DeviceHandle handle~%Timestamp timestamp~%UserProfileHandle user_handle~%Connection connection~%================================================================================~%MSG: kortex_driver/DeviceHandle~%~%uint32 device_type~%uint32 device_identifier~%uint32 order~%================================================================================~%MSG: kortex_driver/Timestamp~%~%uint32 sec~%uint32 usec~%================================================================================~%MSG: kortex_driver/UserProfileHandle~%~%uint32 identifier~%uint32 permission~%================================================================================~%MSG: kortex_driver/Connection~%~%UserProfileHandle user_handle~%string connection_information~%uint32 connection_identifier~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotEventNotification>))
  (cl:+ 0
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RobotEventNotification>))
  "Converts a ROS message object to a list"
  (cl:list 'RobotEventNotification
