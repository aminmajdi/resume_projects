...
"""autogenerated by genpy from kortex_driver/ProtectionZoneNotificationList.msg. Do not edit."""
import codecs
import sys
...
class ProtectionZoneNotificationList(genpy.Message):
  _md5sum = "6066ebbfe639c25e050ba673e5bf1717"
  _type = "kortex_driver/ProtectionZoneNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/ProtectionZoneNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ProtectionZoneNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.ProtectionZoneNotification()
        start = end
        end += 4
