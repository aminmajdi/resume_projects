...
class OnNotificationControllerTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationControllerTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationControllerTopicRequest
    let len;
    let data = new OnNotificationControllerTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationControllerTopicRequest(null);
...
class OnNotificationControllerTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationControllerTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationControllerTopicResponse
    let len;
    let data = new OnNotificationControllerTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationControllerTopicResponse(null);
...
module.exports = {
  Request: OnNotificationControllerTopicRequest,
  Response: OnNotificationControllerTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationControllerTopic'; }
};
