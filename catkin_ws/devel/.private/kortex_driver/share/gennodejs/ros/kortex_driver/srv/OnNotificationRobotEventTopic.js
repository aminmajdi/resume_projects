...
class OnNotificationRobotEventTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationRobotEventTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationRobotEventTopicRequest
    let len;
    let data = new OnNotificationRobotEventTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationRobotEventTopicRequest(null);
...
class OnNotificationRobotEventTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationRobotEventTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationRobotEventTopicResponse
    let len;
    let data = new OnNotificationRobotEventTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationRobotEventTopicResponse(null);
...
module.exports = {
  Request: OnNotificationRobotEventTopicRequest,
  Response: OnNotificationRobotEventTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationRobotEventTopic'; }
};
