...
"""autogenerated by genpy from kortex_driver/OperatingModeNotificationList.msg. Do not edit."""
import codecs
import sys
...
class OperatingModeNotificationList(genpy.Message):
  _md5sum = "52f234be703b9c3a9743364c4bec1c58"
  _type = "kortex_driver/OperatingModeNotificationList"
...
uint32 order"""
  ...
  _slot_types = ['kortex_driver/OperatingModeNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OperatingModeNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.OperatingModeNotification()
        start = end
        end += 4
        (val1.operating_mode,) = _get_struct_I().unpack(str[start:end])
        _v6 = val1.timestamp
        _x = _v6
        start = end
        end += 8
