...
class OnNotificationNetworkTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationNetworkTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationNetworkTopicRequest
    let len;
    let data = new OnNotificationNetworkTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationNetworkTopicRequest(null);
...
class OnNotificationNetworkTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationNetworkTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationNetworkTopicResponse
    let len;
    let data = new OnNotificationNetworkTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationNetworkTopicResponse(null);
...
module.exports = {
  Request: OnNotificationNetworkTopicRequest,
  Response: OnNotificationNetworkTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationNetworkTopic'; }
};
