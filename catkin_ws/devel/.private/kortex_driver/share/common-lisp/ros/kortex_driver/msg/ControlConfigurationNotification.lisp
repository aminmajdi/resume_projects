...
;//! \htmlinclude ControlConfigurationNotification.msg.html

(cl:defclass <ControlConfigurationNotification> (roslisp-msg-protocol:ros-message)
  ((event
    :reader event
    :initarg :event
    :type cl:integer
...
(cl:defclass ControlConfigurationNotification (<ControlConfigurationNotification>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ControlConfigurationNotification>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ControlConfigurationNotification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<ControlConfigurationNotification> is deprecated: use kortex_driver-msg:ControlConfigurationNotification instead.")))

(cl:ensure-generic-function 'event-val :lambda-list '(m))
(cl:defmethod event-val ((m <ControlConfigurationNotification>))
...
(cl:defmethod timestamp-val ((m <ControlConfigurationNotification>))
...
(cl:defmethod user_handle-val ((m <ControlConfigurationNotification>))
...
(cl:defmethod connection-val ((m <ControlConfigurationNotification>))
  ...
  (connection m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ControlConfigurationNotification>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ControlConfigurationNotification>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlConfigurationNotification>)))
  "Returns string type for a message object of type '<ControlConfigurationNotification>"
  "kortex_driver/ControlConfigurationNotification")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlConfigurationNotification)))
  "Returns string type for a message object of type 'ControlConfigurationNotification"
  "kortex_driver/ControlConfigurationNotification")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlConfigurationNotification>)))
  "Returns md5sum for a message object of type '<ControlConfigurationNotification>"
  "82274672ed9d832b1bab454a49feca0a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlConfigurationNotification)))
  "Returns md5sum for a message object of type 'ControlConfigurationNotification"
  "82274672ed9d832b1bab454a49feca0a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ControlConfigurationNotification>)))
  "Returns full string definition for message of type '<ControlConfigurationNotification>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ControlConfigurationNotification)))
  "Returns full string definition for message of type 'ControlConfigurationNotification"
  (cl:format cl:nil "~%uint32 event~%Timestamp timestamp~%UserProfileHandle user_handle~%Connection connection~%================================================================================~%MSG: kortex_driver/Timestamp~%~%uint32 sec~%uint32 usec~%================================================================================~%MSG: kortex_driver/UserProfileHandle~%~%uint32 identifier~%uint32 permission~%================================================================================~%MSG: kortex_driver/Connection~%~%UserProfileHandle user_handle~%string connection_information~%uint32 connection_identifier~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ControlConfigurationNotification>))
  (cl:+ 0
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ControlConfigurationNotification>))
  "Converts a ROS message object to a list"
  (cl:list 'ControlConfigurationNotification
