...
"""autogenerated by genpy from kortex_driver/SendJointSpeedsJoystickCommandRequest.msg. Do not edit."""
import codecs
import sys
...
class SendJointSpeedsJoystickCommandRequest(genpy.Message):
  _md5sum = "57a5d172a4a453cab085a1f9cb6cc0cd"
  _type = "kortex_driver/SendJointSpeedsJoystickCommandRequest"
...
uint32 duration"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendJointSpeedsJoystickCommandRequest, self).__init__(*args, **kwds)
...
def _get_struct_IfI():
    ...
    return _struct_IfI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from kortex_driver/SendJointSpeedsJoystickCommandResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SendJointSpeedsJoystickCommandResponse(genpy.Message):
  _md5sum = "c6c43d221c810050f75091660f63b0cd"
  _type = "kortex_driver/SendJointSpeedsJoystickCommandResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SendJointSpeedsJoystickCommandResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class SendJointSpeedsJoystickCommand(object):
  _type          = 'kortex_driver/SendJointSpeedsJoystickCommand'
  _md5sum = '35bff15135e19b4099e6a92d5e7d08d5'
  _request_class  = SendJointSpeedsJoystickCommandRequest
  _response_class = SendJointSpeedsJoystickCommandResponse
