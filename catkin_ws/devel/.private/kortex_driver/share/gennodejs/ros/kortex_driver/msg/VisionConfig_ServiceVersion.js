...
class VisionConfig_ServiceVersion {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VisionConfig_ServiceVersion(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisionConfig_ServiceVersion(null);
    return resolved;
    }
};

// Constants for message
VisionConfig_ServiceVersion.Constants = {
  RESERVED_0: 0,
  CURRENT_VERSION: 1,
}

module.exports = VisionConfig_ServiceVersion;
