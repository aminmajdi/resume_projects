...
(cl:defclass <GpioEvent> (roslisp-msg-protocol:ros-message)
  ((input_type
    :reader input_type
    :initarg :input_type
    :type cl:integer
...
(cl:defclass GpioEvent (<GpioEvent>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <GpioEvent>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'GpioEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kortex_driver-msg:<GpioEvent> is deprecated: use kortex_driver-msg:GpioEvent instead.")))

(cl:ensure-generic-function 'input_type-val :lambda-list '(m))
(cl:defmethod input_type-val ((m <GpioEvent>))
...
(cl:defmethod behavior-val ((m <GpioEvent>))
...
(cl:defmethod input_identifier-val ((m <GpioEvent>))
  ...
  (input_identifier m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GpioEvent>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GpioEvent>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GpioEvent>)))
  "Returns string type for a message object of type '<GpioEvent>"
  "kortex_driver/GpioEvent")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GpioEvent)))
  "Returns string type for a message object of type 'GpioEvent"
  "kortex_driver/GpioEvent")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GpioEvent>)))
  "Returns md5sum for a message object of type '<GpioEvent>"
  "a8f7ada35fd120a9401b9d95b206763c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GpioEvent)))
  "Returns md5sum for a message object of type 'GpioEvent"
  "a8f7ada35fd120a9401b9d95b206763c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GpioEvent>)))
  "Returns full string definition for message of type '<GpioEvent>"
  (cl:format cl:nil "~%uint32 input_type~%uint32 behavior~%uint32 input_identifier~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GpioEvent)))
  "Returns full string definition for message of type 'GpioEvent"
  (cl:format cl:nil "~%uint32 input_type~%uint32 behavior~%uint32 input_identifier~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <GpioEvent>))
  (cl:+ 0
     4
     4
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GpioEvent>))
