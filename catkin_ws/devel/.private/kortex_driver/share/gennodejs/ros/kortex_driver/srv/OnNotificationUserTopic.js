...
class OnNotificationUserTopicRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationUserTopicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationUserTopicRequest
    let len;
    let data = new OnNotificationUserTopicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationUserTopicRequest(null);
...
class OnNotificationUserTopicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type OnNotificationUserTopicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type OnNotificationUserTopicResponse
    let len;
    let data = new OnNotificationUserTopicResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnNotificationUserTopicResponse(null);
...
module.exports = {
  Request: OnNotificationUserTopicRequest,
  Response: OnNotificationUserTopicResponse,
  md5sum() { return '6fefdd07c6cb63a94f7b48e7e07e815b'; },
  datatype() { return 'kortex_driver/OnNotificationUserTopic'; }
};
