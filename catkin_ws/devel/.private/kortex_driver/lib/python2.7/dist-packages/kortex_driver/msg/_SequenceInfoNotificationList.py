...
"""autogenerated by genpy from kortex_driver/SequenceInfoNotificationList.msg. Do not edit."""
import codecs
import sys
...
class SequenceInfoNotificationList(genpy.Message):
  _md5sum = "064d50868af0284b9e6fb269565cff60"
  _type = "kortex_driver/SequenceInfoNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/SequenceInfoNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SequenceInfoNotificationList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.notifications:
        _x = val1.event_identifier
        buff.write(_get_struct_I().pack(_x))
        _v1 = val1.sequence_handle
        _x = _v1
        buff.write(_get_struct_2I().pack(_x.identifier, _x.permission))
        _x = val1
        buff.write(_get_struct_2I().pack(_x.task_index, _x.group_identifier))
        _v2 = val1.timestamp
        _x = _v2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.SequenceInfoNotification()
        start = end
        end += 4
        (val1.event_identifier,) = _get_struct_I().unpack(str[start:end])
        _v6 = val1.sequence_handle
        _x = _v6
        start = end
        end += 8
        ...
        (_x.task_index, _x.group_identifier,) = _get_struct_2I().unpack(str[start:end])
        _v7 = val1.timestamp
        _x = _v7
        start = end
        end += 8
