...
"""autogenerated by genpy from kortex_driver/NetworkNotificationList.msg. Do not edit."""
import codecs
import sys
...
class NetworkNotificationList(genpy.Message):
  _md5sum = "bc9202ddc3c0c7e7123fa4b58af501d4"
  _type = "kortex_driver/NetworkNotificationList"
...
uint32 connection_identifier"""
  ...
  _slot_types = ['kortex_driver/NetworkNotification[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NetworkNotificationList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kortex_driver.msg.NetworkNotification()
        start = end
        end += 4
