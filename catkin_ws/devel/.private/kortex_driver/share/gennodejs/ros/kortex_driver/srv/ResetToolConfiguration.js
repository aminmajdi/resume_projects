...
class ResetToolConfigurationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ResetToolConfigurationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ResetToolConfigurationRequest
    let len;
    let data = new ResetToolConfigurationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ResetToolConfigurationRequest(null);
...
class ResetToolConfigurationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ResetToolConfigurationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ResetToolConfigurationResponse
    let len;
    let data = new ResetToolConfigurationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ResetToolConfigurationResponse(null);
...
module.exports = {
  Request: ResetToolConfigurationRequest,
  Response: ResetToolConfigurationResponse,
  md5sum() { return '49c06fd31c2188ee0d629d1b8491b1f0'; },
  datatype() { return 'kortex_driver/ResetToolConfiguration'; }
};
