...
class ActuatorCyclic_MessageId {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorCyclic_MessageId(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorCyclic_MessageId(null);
...
module.exports = ActuatorCyclic_MessageId;
