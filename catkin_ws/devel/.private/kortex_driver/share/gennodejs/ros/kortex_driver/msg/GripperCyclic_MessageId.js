...
class GripperCyclic_MessageId {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GripperCyclic_MessageId(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperCyclic_MessageId(null);
...
module.exports = GripperCyclic_MessageId;
