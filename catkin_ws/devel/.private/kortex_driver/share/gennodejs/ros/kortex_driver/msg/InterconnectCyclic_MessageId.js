...
class InterconnectCyclic_MessageId {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new InterconnectCyclic_MessageId(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InterconnectCyclic_MessageId(null);
...
module.exports = InterconnectCyclic_MessageId;
